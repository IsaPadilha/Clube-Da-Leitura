...
public class TelaAmigo : TelaBase, ITelaOpcoes
{
    ...
    public TelaAmigo(string nomeEntidade, RepositorioAmigo repositorioAmigo, RepositorioEmprestimo repositorioEmprestimo) : base(nomeEntidade, repositorioAmigo)
    {
        this.repositorioAmigo = repositorioAmigo;
        this.repositorioEmprestimo = repositorioEmprestimo;
    }

    // override = sobrescrita / substituicao
